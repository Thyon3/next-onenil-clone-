    ...
    return (
        <section className="bg-black px-10 pb-[120px]">
            <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
                <Link href="/archive" className="relative block rounded-lg min-h-[420px] overflow-hidden transition duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-2 shadow-lg" style={{ backgroundImage: 'linear-gradient(135deg, #4f46e5 0%, #06b6d4 100%)' }}>
